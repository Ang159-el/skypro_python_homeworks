...
from lesson7.constants import Filling_form_URL
from lesson7.constants import *
...
class MainPage:
    ...
    # Находим нужные поля для заполнения на главной странице
    def find_fields(self):
        self._first_name = (By.NAME, "first-name")
        self._last_name = (By.NAME, "last-name")
        self._adress = (By.NAME, "adress")
    ...
    def click_submit_button(self)
        WebDriverWait(self.browser, 40, 0.1).until(EC.element_to_be_clickable(self._button)).click() WebDriverWait(self.browser, 40, 0.1).until(EC.element_to_be_clickable(self._button)).click()
